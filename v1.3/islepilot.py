...
# wss://islepilot.eu/ows exists in the reference client's protocol and its
# handshake succeeds, but it delivered zero live frames in live testing
# (multiple auth variants, confirmed while actually online in-game) — so
# REST /api/overlay/me is the sole, working data source. Polled fast since
# it's carrying position/yaw now, not just slow metadata.
...
# --------------------------------------------------------------------- #
# Live data polling — REST only. See POLL_INTERVAL_SECONDS above for why.
# --------------------------------------------------------------------- #
